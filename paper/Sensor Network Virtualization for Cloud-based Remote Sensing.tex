...
Second, the highest number of hops a message experiences is analyzed. Figure~\ref{fig:maxhops} shows that with a growing number of nodes, also the maximum of the number of hops grows. Nonetheless, the overall impression is that the number of hops is generally speaking, more or less constant and mostly is found to range from 15 to 20. 
%\textcolor{red}{Boxplot more appropriate?}
%TODO wite another sentence...?
...
%\begin{figure}
% \centering
% \includegraphics[width=3in]{figs/maxhops}
...
%\begin{figure}
% \centering
% \includegraphics[width=3in]{figs/maxtime}
