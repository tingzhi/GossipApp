...
%Time seems a bad indicator because it only depends on gossipInterval and random fluctuations.
%Hops with 1 iteration. At least fluctuations of 2%
%simulation, iteration, nodes
%gathering
%
...
% \includegraphics[width=2.5in]{figs/avgmsg}
 \caption{The average number of messages each node sent over the uration of a whole simulation.}
 \label{fig:avgmsg}
\end{figure}
